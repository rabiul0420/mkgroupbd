                    ...
                    <div class="card-body">
                        <form action="{{ $route }}" class="form" method="POST" id="prevent-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label>Unit Price {!! starSign() !!}</label>
                                        <input type="number" name="unit_price"
                                            value="{{ old('unit_price') ?? $data->unit_price ?? '' }}"
                                            class="form-control {!! hasError('unit_price') !!}" placeholder="Unit Price" />
                                        @error('unit_price')
                                        {!! displayError($message) !!}
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control {!! hasError('description') !!}" cols="30" rows="5"
                                ...
                                <div class="col-12 text-right">
                                    <a href="{{ route('admin.income-sectors.index') }}" class="btn btn-info">Back</a>
