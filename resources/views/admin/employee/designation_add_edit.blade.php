                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control {!! hasError('description') !!}" cols="30" rows="1"
                                ...
                                <div class="col-12 text-right">
                                    <a href="{{ route('admin.employee-designations.index') }}" class="btn btn-info">Back</a>
